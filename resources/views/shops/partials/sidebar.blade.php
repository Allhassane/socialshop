<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="/shops/assets/img/logo.png" class="header-logo" /> <span
                    class="logo-name">Zivi</span>
            </a>
        </div>
        <div class="sidebar-user">
            <div class="sidebar-user-picture">
                <img alt="image" src="/shops/assets/img/user.png">
            </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i
            ...
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Apps</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Email</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i data-feather="copy"></i><span>Basic
                  Components</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="active"><a class="nav-link" href="blank.html"><i data-feather="file"></i><span>Blank
                  Page</span></a></li>
            <li class="menu-header">Zivi</li>
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i data-feather="layout"></i><span>Forms</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i data-feather="grid"></i><span>Tables</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i data-feather="feather"></i><span>Icons</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i data-feather="image"></i><span>Gallery</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i data-feather="flag"></i><span>Sliders</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i data-feather="map"></i><span>Google
                  Maps</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="blank.html#" class="menu-toggle nav-link has-dropdown"><i data-feather="anchor"></i><span>Other
                  Pages</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="blank.html#">Menu 1</a></li>
                    <li class="dropdown">
                        <a href="blank.html#" class="has-dropdown">Menu 2</a>
                        <ul class="dropdown-menu">
                            <li><a href="blank.html#">Child Menu 1</a></li>
                            <li class="dropdown">
                                <a href="blank.html#" class="has-dropdown">Child Menu 2</a>
                                <ul class="dropdown-menu">
                                    <li><a href="blank.html#">Child Menu 1</a></li>
                                    <li><a href="blank.html#">Child Menu 2</a></li>
                                </ul>
                            </li>
                            <li><a href="blank.html#"> Child Menu 3</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
